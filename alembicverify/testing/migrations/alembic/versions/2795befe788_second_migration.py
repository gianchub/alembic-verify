...
def upgrade():
    ...
    op.add_column('employees', sa.Column('number_of_pets', sa.Integer(), nullable=False))
    ...
    op.alter_column('phone_numbers', 'number',
...
def downgrade():
    ...
    op.alter_column('phone_numbers', 'number',
               existing_type=mysql.VARCHAR(length=40),
               nullable=True)
    op.add_column('employees', sa.Column('favourite_meal', mysql.ENUM('meat', 'vegan', 'vegetarian'), nullable=False))
